...
- **WHEN** a service has `metaTitle: "Création site web pro"` and `metaDescription: "Je crée votre site..."` in the database
- **THEN** the HTML `<title>` SHALL be "Création site web pro | FreelanceHigh" and `<meta name="description">` SHALL be "Je crée votre site..."
...
- **WHEN** a service has a rating of 4.5, 12 reviews, and base price of €50
