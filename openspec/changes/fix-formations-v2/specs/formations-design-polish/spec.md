...
- **WHEN** A user loads `/formations/{slug}`
...
- **WHEN** A logged-in learner loads `/formations/mes-formations`
...
- **WHEN** A learner has items in cart and loads `/formations/panier`
...
- **WHEN** A user navigates to `/formations/instructeurs/{id}`
