...
- **THEN** the system SHALL display "Ce service est deja en boost actif jusqu'au [date]"
...
- **THEN** the page SHALL display final stats with a "Boost termine" badge and a "Renouveler le boost" button
