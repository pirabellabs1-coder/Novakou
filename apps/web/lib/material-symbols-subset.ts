...
export const MATERIAL_SYMBOLS_USED = [
  ...
  "done", "done_all", "donut_large", "download", "download_done", "draft",
  ...
  "security", "sell", "send", "send_money", "settings", "share", "shield",
  ...
  "video_library", "videocam", "view_carousel", "view_column", "view_column_2",
