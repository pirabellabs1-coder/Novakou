...
export const DEMO_PLANS: SubscriptionPlan[] = [
  {
    ...
    price: 0,
    commission: 12,
    features: ["7 services actifs", "10 candidatures/mois", "Commission 12%", "Support email", "Profil public"],
    servicesLimit: 7,
  ...
  },
  {
    ...
    price: 15,
    commission: 0,
    features: ["Services illimites", "20 candidatures/mois", "5 boosts/mois", "1 EUR/vente", "Certifications IA", "Support prioritaire", "Badge Pro"],
    servicesLimit: null,
  ...
  },
  {
    ...
    price: 45,
    commission: 0,
    features: ["Services illimites", "Candidatures illimitees", "10 boosts/mois", "1 EUR/vente", "Cles API", "Analytics avances", "Badge Business", "Support dedie"],
    servicesLimit: null,
