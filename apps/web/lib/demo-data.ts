...
export const DEMO_PLANS: SubscriptionPlan[] = [
  ...
  },
  {
    ...
    price: 15,
    commission: 10,
    features: ["15 services actifs", "30 candidatures/mois", "3 boosts/mois", "Commission 10%", "1 certification IA/mois", "Statistiques avancees", "Support prioritaire"],
    servicesLimit: 15,
  ...
  },
  {
    ...
    price: 20,
    commission: 10,
    features: ["Services illimites", "Candidatures illimitees", "Commission 10%", "5 boosts/mois", "Jusqu'a 5 membres", "CRM clients", "10 GB stockage", "Support prioritaire"],
    servicesLimit: null,
    candidaturesLimit: null,
    boostLimit: 5,
    current: false,
