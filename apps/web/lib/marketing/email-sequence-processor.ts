...
const SEED_STEPS: SequenceStepRecord[] = [
  // Onboarding sequence
  {
    ...
    stepOrder: 0,
    stepType: "EMAIL",
    subjectFr: "Bienvenue ! Voici comment bien démarrer",
    bodyFr: "Bonjour {{name}}, bienvenue sur Novakou ! Découvrez nos formations...",
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
  ...
  },
  {
    ...
    stepOrder: 2,
    stepType: "EMAIL",
    subjectFr: "Avez-vous exploré notre catalogue ?",
  ...
  },
  {
    ...
    stepOrder: 5,
    stepType: "EMAIL",
    subjectFr: "Votre code -10 % expire bientôt",
    bodyFr: "Bonjour {{name}}, profitez de -10 % sur votre première formation avec le code WELCOME10...",
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
