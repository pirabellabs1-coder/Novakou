...
const DEFAULT_CONFIG: PlatformConfig = {
  ...
  plans: {
    ...
    ascension: { price: 15, priceAnnual: 135, maxServices: 15, maxCandidatures: 30, boostsPerMonth: 3, commissionType: "percentage", commissionValue: 10, scenarioLimit: 3, certificationLimit: 1, productiviteAccess: false, teamLimit: 0, crmAccess: false, cloudStorageGB: 0, apiAccess: false, supportLevel: "prioritaire", features: ["15 services actifs", "30 candidatures/mois", "Commission 10%", "3 boosts/mois", "1 certification IA/mois", "3 scénarios automatisés", "Statistiques avancées", "Support prioritaire"] },
