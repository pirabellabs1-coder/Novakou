...
export function StatCard({
  ...
  return (
    <div className={cn("bg-neutral-dark rounded-xl border border-border-dark p-3 sm:p-4 lg:p-5", className)}>
      <div className="flex items-center justify-between mb-2 sm:mb-3">
        <p className="text-slate-400 text-xs sm:text-sm font-medium">{label}</p>
        <div className={cn("w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center", iconBg)}>
  ...
  return (
    <div className="bg-neutral-dark rounded-xl border border-border-dark p-3 sm:p-4 lg:p-5 animate-pulse">
      <div className="flex items-center justify-between mb-2 sm:mb-3">
        ...
        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-border-dark rounded-lg" />
      </div>
