      ...
      <section className="py-16 px-6 bg-gradient-to-br from-slate-900 to-[#006e2f]/40 text-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <Link href="/formations/contact?subject=partnership" className="inline-flex items-center gap-2 bg-white text-[#006e2f] px-7 py-4 rounded-2xl font-extrabold text-sm hover:bg-slate-100 transition-colors shadow-xl">
