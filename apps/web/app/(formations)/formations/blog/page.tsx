    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Manrope', sans-serif" }}>
      ...
      <section className="px-6 mb-16">
        <div className="max-w-7xl mx-auto">
          <Link href={`/formations/blog/${FEATURED.slug}`} className="group block bg-white rounded-3xl border border-slate-100 overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all">
      ...
      <section className="px-6 pb-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {ARTICLES.map((a) => (
              <Link key={a.slug} href={`/formations/blog/${a.slug}`} className="group block bg-white rounded-2xl border border-slate-100 overflow-hidden hover:shadow-xl hover:-translate-y-0.5 transition-all">
