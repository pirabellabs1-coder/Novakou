      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-br from-[#006e2f] to-[#22c55e] rounded-3xl p-12 md:p-16 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/formations/inscription?role=instructeur" className="px-7 py-4 rounded-2xl bg-white text-[#006e2f] font-bold text-sm hover:bg-slate-100 transition-colors">
              Créer ma boutique
            </Link>
            <Link href="/formations/explorer" className="px-7 py-4 rounded-2xl bg-white/15 backdrop-blur text-white font-bold text-sm hover:bg-white/25 transition-colors border border-white/30">
