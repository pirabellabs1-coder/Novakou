...
const PRODUCT_TYPES = [
  {
    ...
    href: "/formations/explorer?type=formations",
  ...
  },
  {
    ...
    href: "/formations/explorer?type=products&kind=PDF",
  ...
  },
  {
    ...
    href: "/formations/explorer?type=products&kind=TEMPLATE",
  ...
  },
  {
    ...
    href: "/formations/explorer?type=products&kind=AUDIO",
    cta: "Voir les audios",
  },
  {
    icon: "video_call",
  ...
  },
  {
    ...
    href: "/formations/explorer?type=products&kind=BUNDLE",
    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Manrope', sans-serif" }}>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-br from-slate-900 to-[#006e2f]/40 rounded-3xl p-12 text-white">
          ...
          <Link href="/formations/explorer" className="inline-flex items-center gap-2 bg-white text-[#006e2f] px-7 py-4 rounded-2xl font-bold text-sm hover:bg-slate-100 transition-colors">
