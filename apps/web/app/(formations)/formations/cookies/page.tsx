      ...
      <section className="px-6 pb-20">
        <div className="max-w-4xl mx-auto bg-slate-50 rounded-2xl p-8">
          ...
          <div className="space-y-3 text-sm text-[#5c647a] leading-relaxed">
            ...
            <p className="pt-3">Pour exercer vos droits ou poser une question : <Link href="/formations/contact" className="text-[#006e2f] font-semibold underline">contactez-nous</Link>.</p>
          </div>
        </div>
      </section>
    </div>
