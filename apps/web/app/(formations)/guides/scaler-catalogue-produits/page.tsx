...
const SEO_TITLE = "Scaler catalogue produit digital : x10 revenus";
const SEO_DESCRIPTION =
  "Passez de 1 formation à un catalogue complet et multipliez votre revenu : bundles, abonnements, ladder de prix. La méthode Novakou pour scaler ses ventes.";
const OG_IMAGE = `${APP_URL}/api/og?type=guide&title=${encodeURIComponent(
  "Scaler son catalogue produit digital",
)}&subtitle=${encodeURIComponent(
  "Bundles, abonnements, ladder de prix : ×10 votre revenu Novakou",
)}`;
