...
function InscriptionInner() {
  ...
  const redirectAfterAuth = callbackUrl ?? (
    activeTab === "vendeur" ? "/vendeur/dashboard" :
    activeTab === "mentor" ? "/mentor/dashboard" :
    activeTab === "affilie" ? "/affilie/dashboard" :
    "/apprenant/dashboard"
  );
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-7">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start gap-3 pt-1">
                ...
                <label htmlFor="terms" className="text-xs text-[#5c647a] leading-relaxed cursor-pointer">
                  J&apos;accepte les{" "}
                  <Link href="/cgu" className="text-[#006e2f] font-semibold hover:underline">conditions générales</Link>{" "}
                  et la{" "}
                  <Link href="/confidentialite" className="text-[#006e2f] font-semibold hover:underline">politique de confidentialité</Link>.
                </label>
              </div>
            ...
            <p className="text-center text-sm text-[#5c647a] mt-5">
              Déjà un compte ?{" "}
              <Link href="/connexion" className="text-[#006e2f] font-bold hover:underline">Se connecter</Link>
            </p>
          </div>
