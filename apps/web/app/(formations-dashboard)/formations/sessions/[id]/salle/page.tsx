...
export default function SalleJitsiPage() {
  ...
  useEffect(() => {
    ...
    api.on("videoConferenceLeft", () => {
      ...
      setTimeout(() => {
        router.push(booking.viewerRole === "student" ? "/formations/apprenant/sessions" : "/formations/mentor/rendez-vous");
      }, 1500);
    });
    ...
    <div className="min-h-screen bg-black flex flex-col" style={{ fontFamily: "'Manrope', sans-serif" }}>
      ...
      <header className="bg-[#0f172a] text-white px-4 py-2.5 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          <Link href={booking.viewerRole === "student" ? "/formations/apprenant/sessions" : "/formations/mentor/rendez-vous"}
