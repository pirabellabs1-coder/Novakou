...
export default function EditerProduitPage() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => router.push("/formations/vendeur/produits"),
  });
    ...
    return (
      <div className="min-h-screen bg-[#f7f9fb] flex items-center justify-center p-8">
        <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center max-w-md">
          ...
          <Link href="/formations/vendeur/produits" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-white text-sm font-bold" style={{ background: "linear-gradient(to right, #006e2f, #22c55e)" }}>
    ...
    <div className="min-h-screen bg-[#f7f9fb]">
      ...
      <div className="bg-white border-b border-gray-100 sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-5 md:px-8 h-14 flex items-center gap-3">
          <Link href="/formations/vendeur/produits" className="text-[#5c647a] hover:text-[#191c1e]">
          ...
          <a href={`/formations/produit/${product.slug}`} target="_blank" rel="noopener noreferrer"
