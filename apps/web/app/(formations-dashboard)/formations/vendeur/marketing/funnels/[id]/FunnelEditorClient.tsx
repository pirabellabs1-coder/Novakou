  ...
  switch (stepType) {
    ...
    case "THANK_YOU":
      return [
        ...
        { id: newBlockId(), type: "cta", data: { headline: "Accédez à votre espace", subheadline: "Tous vos achats et formations au même endroit", ctaText: "Accéder à mon espace", ctaLink: "/formations/acheteur/mes-achats" } },
      ];
    default:
      return [];
  }
