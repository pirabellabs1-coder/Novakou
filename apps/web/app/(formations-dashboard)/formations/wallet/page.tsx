        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5">
            ...
            {data.mentor ? (
              ...
              <p className="text-xs text-[#5c647a]">
                Aucun profil mentor.{" "}
                <Link href="/formations/inscription?role=mentor" className="text-[#006e2f] font-semibold">
                  Devenir mentor
                </Link>
              </p>
            )}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5">
            ...
            {data.affiliate ? (
              <>
                ...
                <Link
                  href="/formations/affilie/retraits"
              ...
              <p className="text-xs text-[#5c647a]">
                ...
                <Link href="/formations/affiliation" className="text-[#006e2f] font-semibold">
                  Rejoindre
                </Link>
              </p>
            )}
