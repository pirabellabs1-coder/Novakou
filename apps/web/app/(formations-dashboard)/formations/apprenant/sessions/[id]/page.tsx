    ...
    return (
      <div className="p-6">
        <div className="bg-red-50 border border-red-200 rounded-xl p-6 text-center">
          ...
          <button
            onClick={() => router.push("/formations/apprenant/sessions")}
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
        ...
        <div className="p-5 space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <Link href={`/formations/mentors/${data.mentor.id}`} className="text-base font-bold text-[#191c1e] hover:underline">
                {data.mentor.name}
              </Link>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Link
          href={`/formations/messages?to=${data.mentor.userId}`}
