            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between flex-wrap gap-3">
                <div>
                  ...
                  <p className="text-primary font-medium">{vendor.title}</p>
                  <div className="flex items-center gap-2 mt-1 text-sm text-slate-400">
                    ...
                    {vendor.teamSize && (
                      <>
                        ...
                        <span>{vendor.teamSize} membres</span>
                      </>
                    )}
                  </div>
                </div>
              ...
              <div className="flex flex-wrap gap-4 mt-4 text-sm">
                ...
                <div className="flex items-center gap-1.5 text-slate-400">
                  ...
                  {vendor.totalOrders} projets livrés
                </div>
                <div className="flex items-center gap-1.5 text-slate-400">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex border-b border-white/10 mb-6">
              {([
                ...
                { key: "portfolio", label: "Réalisations", count: vendor.portfolioImages?.length || 0 },
          ...
          <aside className="w-full lg:w-64 flex-shrink-0 space-y-4">
            ...
            {vendor.description && (
              <div className="bg-[#1a1f2e] border border-white/10 rounded-2xl p-4">
                ...
                <p className="text-xs text-slate-400 leading-relaxed">{vendor.description}</p>
              </div>
            )}
              ...
              <div className="space-y-2.5">
                {vendor.teamSize && (
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="text-white font-semibold">{vendor.teamSize} personnes</span>
                  </div>
                )}
                <div className="flex justify-between text-xs">
