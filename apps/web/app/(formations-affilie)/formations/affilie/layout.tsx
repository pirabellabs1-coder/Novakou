...
const navItems = [
  { icon: "bar_chart",          label: "Tableau de bord", href: "/formations/affilie/dashboard" },
  { icon: "link",               label: "Mes liens",       href: "/formations/affilie/liens" },
  { icon: "payments",           label: "Commissions",     href: "/formations/affilie/commissions" },
  { icon: "account_balance_wallet", label: "Retraits",    href: "/formations/affilie/retraits" },
  { icon: "leaderboard",        label: "Performances",    href: "/formations/affilie/performances" },
];
  ...
  return (
    <div className="min-h-screen bg-[#0a1510]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0d1f17] border-b border-[#1e3a2f] h-16 flex items-center px-4 md:px-6 gap-4">
        ...
        <Link
          href="/formations/apprenant/dashboard"
