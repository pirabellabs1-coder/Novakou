...
const updateFormationSchema = z.object({
  titleFr: z.string().min(5).max(80).optional(),
  titleEn: z.string().min(5).max(80).optional(),
  shortDescFr: z.string().max(200).optional().nullable(),
  shortDescEn: z.string().max(200).optional().nullable(),
  descriptionFr: z.string().optional().nullable(),
  descriptionEn: z.string().optional().nullable(),
  learnPointsFr: z.array(z.string()).optional(),
  learnPointsEn: z.array(z.string()).optional(),
  requirementsFr: z.array(z.string()).optional(),
  requirementsEn: z.array(z.string()).optional(),
  targetAudienceFr: z.string().optional().nullable(),
  targetAudienceEn: z.string().optional().nullable(),
