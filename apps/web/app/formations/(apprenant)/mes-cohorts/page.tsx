...
import { Calendar, Users, MessageSquare, Play, Award, Clock } from "lucide-react";
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">{fr ? "Mes cohortes" : "My Cohorts"}</h1>
          <p className="text-sm text-slate-500">{fr ? "Vos formations en groupe" : "Your group courses"}</p>
        </div>
        <Link href="/formations/mes-cohorts"
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-semibold text-slate-900 text-sm line-clamp-1">{cohortTitle}</h3>
